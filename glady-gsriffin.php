<?php
$page_title       = 'Glady Griffin — Case Study | Book Spire Publishing';
$meta_description = 'Read how Glady Griffin achieved her publishing goals with the help of Book Spire Publishing.';
$canonical_url    = 'https://bookspirepublishing.com/glady-gsriffin.php';
$page_css         = 'assets/css/style-10.css?ver=1771958922';
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="case_detail_data">
                        <img alt="twt_img" class="img-fluid" src="assets/images/case_pics/14.png">
                        <div class="baner_data">
                            <h4><span class="onge_ban">Stories</span> ➟ Gladys Griffin</h4>
                            <h1>An Olive Branch in Her Time of Need God’s Grace is Sufficient for Me</h1>
